...
uint8_t i2c_start(I2C_Control *dev, uint8_t address, uint8_t mode);
uint8_t i2c_start_addr(I2C_Control *dev,uint8_t addr,enum I2C_RW rw);

uint8_t i2c_write(I2C_Control *dev, uint8_t address, uint8_t reg, uint8_t *data, uint8_t len);
...
uint8_t i2c_read(I2C_Control *dev, uint8_t address, uint8_t reg);
